...
| ---------------------------------- | --------- | ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| **Request OTP with Valid Email**   | Normal    | 1. Send a `POST` request to `/auth/otp` with a valid JSON body, e.g., `{"email": "test@example.com"}`.             | - **Status Code:** `200 OK`<br>- **Response Body:** Contains a success message and the generated OTP string.        |
...
| Test Case Name                            | Type      | Verification Steps                                                                                                                                                                                                                                                               | Expected Result                                                                                                                 |
| ----------------------------------------- | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| **Verify with Correct OTP**               | Normal    | 1. Request an OTP for a valid email (e.g., `test@example.com`) by calling `/auth/otp`.<br>2. Send a `POST` request to `/auth/verify` with the same email and the OTP received from step 1.                                                                                           | - **Status Code:** `200 OK`<br>- **Response Body:** Contains a `token` field with a valid Firebase custom token (JWT string).    |
